...
namespace TerrainEngine2D
{
    ...
    public static class Serialization
    {
        ...
        /// </summary>
        public static string DefaultSaveLocation = UnityEngine.Application.persistentDataPath + "/" + SaveFolderName + "/";
        /// <summary>
        /// The default save location for testing in the editor
        /// </summary>
        public static string EditorSaveLocation = UnityEngine.Application.streamingAssetsPath + "/" + SaveFolderName + "/";
        /// <summary>
        ...
        public static void SaveBaseData()
        {
            ...
            UnityEngine.Debug.Log("World Base Data has been saved to file at: " + saveFilePath);
        }
        ...
        public static bool LoadBaseData(WorldData worldData, string saveFolderPath)
        {
            ...
            } else
            {
                ...
                UnityEngine.Debug.LogWarning("Could not find BaseData file");
            }
            return false;
        }
        ...
        public static void SaveTerrainData()
        {
            ...
            UnityEngine.Debug.Log("Terrain Data has been saved to file at: " + saveFilePath);
        }
        ...
        public static bool LoadTerrainData(string saveFolderPath)
        {
            ...
            {
                UnityEngine.Debug.LogError("Could not find TerrainData file");
            }
            return false;
        }
